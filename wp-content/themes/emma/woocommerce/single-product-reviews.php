 ...
 * Theme Note
 * -------------------
 * - Changed from "review_form_wrapper" to "review_form_wrapper-custom" to disable showing on lightbox
 * - Changed the review paging styles
...
<div id="reviews">
	<div id="comments">
		...
		<?php if ( have_comments() ) : ?>
			...
			<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) :
				...
				echo '<div id="wooc-review-comments" class="navigation comment-paging">';
				
					$comment_paging_args = array(
				    							//'current' => $current_page,
				    							'prev_text' 	=> '<i class="icon-angle-left"></i>', 
				    							'next_text' 	=> '<i class="icon-angle-right"></i>',
				    							'add_fragment' 	=> '#comment-1',	
											);
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->id ) ) : ?>
		...
		<div id="review_form_wrapper-custom">
			<div id="review_form">
				<?php
