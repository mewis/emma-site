  ...
  "params" => array(
    ...
    uxbarn_get_button_border_style(),
      ...
      array(
         ...
         'param_name' => 'uxb_icon',
         'value' => '',
         'description' => sprintf(__('<a href="%s" target="_blank">Click here to see all available icons</a>. Just copy and paste the icon code into the text field. For example: <em>icon-asterisk</em>. Leave this field blank when not to use icon.', 'js_composer'), get_template_directory_uri() . '/css/FontAwesome/preview.html'),
         'admin_label' => false,
      ),
...
vc_map( array(
   ...
   'params' => array(
      array(
         ...
         'param_name' => 'address',
         'value' => '',
         'description' => __('By default, the theme will use this address field as a primary value for generating the map. For example: <em>New York, US</em>. <br/><strong>NOTE:</strong> In case you want to use latitude and logitude values below, just leave this field blank.', 'js_composer'),
      ),
      array(
         'type' => 'textfield',
         'holder' => 'div',
